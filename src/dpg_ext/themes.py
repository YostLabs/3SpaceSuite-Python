...
def __add_disabled_themes():
    #Disabled themes. Have to do per type because of a bug
    for comp_type in (dpg.mvMenuItem, dpg.mvButton, dpg.mvText, dpg.mvCheckbox):
        with dpg.theme_component(comp_type, enabled_state=False):
            dpg.add_theme_color(dpg.mvThemeCol_Text, (0.40 * 255, 0.40 * 255, 0.40 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_CheckMark, (0.40 * 255, 0.40 * 255, 0.40 * 255, 1.00 * 255))

def create_theme_imgui_default() -> Union[str, int]:
    with dpg.theme(label="ImguiDefaultTheme") as theme_id:
        __add_disabled_themes()
    return theme_id

def create_theme_imgui_dark() -> Union[str, int]:

    with dpg.theme(label="ImguiDarkTheme") as theme_id:
        __add_disabled_themes()
...
def create_theme_imgui_light() -> Union[str, int]:
    ...
    with dpg.theme(label="ImguiLightTheme") as theme_id:
        __add_disabled_themes()
        
        with dpg.theme_component(0):
            dpg.add_theme_color(dpg.mvThemeCol_Text                   , (0.00 * 255, 0.00 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextDisabled           , (0.40 * 255, 0.40 * 255, 0.40 * 255, 1.00 * 255))
            ...
            dpg.add_theme_color(dpg.mvPlotCol_PlotBg        , (0.42 * 255, 0.57 * 255, 1.00 * 255, 0.40 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_PlotBorder    , (0.10 * 255, 0.10 * 255, 0.10 * 255, 0.40 * 255), category=dpg.mvThemeCat_Plots)
            ...
            #Can't see fields without this when using a white background
            dpg.add_theme_style(dpg.mvStyleVar_FrameBorderSize, 1)

    return theme_id

def create_start_button_theme():
    with dpg.theme(label="Start Button Theme") as start_theme:
...
def create_stop_button_theme():
    with dpg.theme(label="Stop Button Theme") as stop_theme:
        with dpg.theme_component(dpg.mvButton):
