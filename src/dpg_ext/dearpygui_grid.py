...
class ItemData:
    ...
    #Added this because the author appears to have intended for ItemData to be removed from set based on the
    #equivalence operator, but only added the hash function
...
class Grid(_GridComponent):
    ...
    def clear(self):
        ...
        with self._lock:
            ...
            dearpygui.delete_item(self._drawlayer, children_only=False)
